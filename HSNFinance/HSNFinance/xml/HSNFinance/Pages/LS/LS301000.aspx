...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
  <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Filter" Width="100%" Height="80px" AllowAutoHide="false">
	...
	<px:PXTextEdit runat="server" ID="CstPXTextEdit9" DataField="StlmtAcctID_description" ></px:PXTextEdit></Template>
  </px:PXFormView>
</asp:Content>
<asp:Content ID="cont3" ContentPlaceHolderID="phG" Runat="Server">
	<px:PXSplitContainer runat="server" Orientation="Horizontal" SplitterPosition="350" ID="splitConditions">
		...
		<Template1>
			<px:PXGrid ScrollBars="Always" AllowPaging="True" Caption="Ledger Source" CaptionVisible="True" runat="server" SyncPosition="True" Height="300px" SkinID="Primary" TabIndex="700" Width="100%" ID="grdScanMaster" DataSourceID="ds" AdjustPageSize="Auto">
				...
				<Mode AllowAddNew="False" InitNewRow="True" ></Mode></px:PXGrid></Template1>
		<Template2>
				...
				<Levels>
					<px:PXGridLevel DataMember="GLTranCredit">
						<Columns >
							...
							<px:PXGridColumn DataField="TaskID" Width="70" ></px:PXGridColumn>
							<px:PXGridColumn DataField="CostCodeID" Width="70" ></px:PXGridColumn></Columns></px:PXGridLevel></Levels>
				<Mode InitNewRow="True" ></Mode></px:PXGrid></Template2></px:PXSplitContainer></asp:Content>